function noty(e) {
    ...
    return jQuery.each(e, function (i, o) {
        if (n[i]) {
            t++;
            var r = n[i].split(".");
            e[r[0]] || (e[r[0]] = {}), e[r[0]][r[1]] = o ? o : function () {
            }, delete e[i]
        }
...
!function (e, t) {
    ...
    function u(e, t, n, i) {
        if (rt.acceptData(e)) {
            var o, r, s = rt.expando, a = e.nodeType, l = a ? rt.cache : e, c = a ? e[s] : e[s] && s;
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof t)return c || (c = a ? e[s] = G.pop() || rt.guid++ : s), l[c] || (l[c] = a ? {} : {toJSON: rt.noop}), ("object" == typeof t || "function" == typeof t) && (i ? l[c] = rt.extend(l[c], t) : l[c].data = rt.extend(l[c].data, t)), r = l[c], i || (r.data || (r.data = {}), r = r.data), void 0 !== n && (r[rt.camelCase(t)] = n), "string" == typeof t ? (o = r[t], null == o && (o = r[rt.camelCase(t)])) : o = r, o
        }
    }

    function d(e, t, n) {
        if (rt.acceptData(e)) {
            var i, o, r = e.nodeType, s = r ? rt.cache : e, a = r ? e[rt.expando] : rt.expando;
            if (s[a]) {
    ...
    function g(e, t) {
        var n, i, o = 0, r = typeof e.getElementsByTagName !== kt ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll !== kt ? e.querySelectorAll(t || "*") : void 0;
    ...
    function x(e, t) {
        if (1 === t.nodeType && rt.hasData(e)) {
            var n, i, o, r = rt._data(e), s = rt._data(t, r), a = r.events;
            if (a) {
    ...
    function k(t, n) {
        var i = rt(n.createElement(t)).appendTo(n.body), o = e.getDefaultComputedStyle ? e.getDefaultComputedStyle(i[0]).display : rt.css(i[0], "display");
        return i.detach(), o
    }

    function T(e) {
        var t = mt, n = en[e];
        return n || (n = k(e, t), "none" !== n && n || (Zt = (Zt || rt("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (Zt[0].contentWindow || Zt[0].contentDocument).document, t.write(), t.close(), n = k(e, t), Zt.detach()), en[e] = n), n
    }
    ...
    function A(e, t) {
        for (var n, i, o, r = [], s = 0, a = e.length; a > s; s++)i = e[s], i.style && (r[s] = rt._data(i, "olddisplay"), n = i.style.display, t ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Nt(i) && (r[s] = rt._data(i, "olddisplay", T(i.nodeName)))) : r[s] || (o = Nt(i), (n && "none" !== n || !o) && rt._data(i, "olddisplay", o ? n : rt.css(i, "display"))));
    ...
    function F(e, t, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > r; r += 2)"margin" === n && (s += rt.css(e, n + At[r], !0, o)), i ? ("content" === n && (s -= rt.css(e, "padding" + At[r], !0, o)), "margin" !== n && (s -= rt.css(e, "border" + At[r] + "Width", !0, o))) : (s += rt.css(e, "padding" + At[r], !0, o), "padding" !== n && (s += rt.css(e, "border" + At[r] + "Width", !0, o)));
        return s
    }

    function j(e, t, n) {
        var i = !0, o = "width" === t ? e.offsetWidth : e.offsetHeight, r = tn(e), s = it.boxSizing() && "border-box" === rt.css(e, "boxSizing", !1, r);
        if (0 >= o || null == o) {
    ...
    function L(e, t, n) {
        var i, o, r, s, a, l, c, u, d = this, h = {}, p = e.style, f = e.nodeType && Nt(e), m = rt._data(e, "fxshow");
        ...
        })), 1 === e.nodeType && ("height"in t || "width"in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], c = rt.css(e, "display"), u = T(e.nodeName), "none" === c && (c = u), "inline" === c && "none" === rt.css(e, "float") && (it.inlineBlockNeedsLayout && "inline" !== u ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", it.shrinkWrapBlocks() || d.always(function () {
        ...
        if (!rt.isEmptyObject(h)) {
            ...
            for (i in h)s = D(f ? m[i] : 0, i, d), i in m || (m[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function M(e, t, n) {
        var i, o, r = 0, s = _n.length, a = rt.Deferred().always(function () {
            delete l.elem
        }), l = function () {
            if (o)return !1;
        ...
        return rt.map(u, D, c), rt.isFunction(c.opts.start) && c.opts.start.call(e, c), rt.fx.timer(rt.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    function H(e) {
        return function (t, n) {
            ...
            var i, o = 0, r = t.toLowerCase().match(_t) || [];
    ...
    function W(e, t, n, i) {
        ...
        if (rt.isArray(t))rt.each(t, function (t, o) {
            n || Xn.test(e) ? i(e, o) : W(e + "[" + ("object" == typeof o ? t : "") + "]", o, n, i)
        }); else if (n || "object" !== rt.type(t))i(e, t); else for (o in t)W(e + "[" + o + "]", t[o], n, i)
    }
    ...
    var G = [], X = G.slice, Y = G.concat, J = G.push, K = G.indexOf, Z = {}, et = Z.toString, tt = Z.hasOwnProperty, nt = "".trim, it = {}, ot = "1.11.0", rt = function (e, t) {
        return new rt.fn.init(e, t)
    }, st = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, at = /^-ms-/, lt = /-([\da-z])/gi, ct = function (e, t) {
        return t.toUpperCase()
    };
    rt.fn = rt.prototype = {
        jquery: ot, constructor: rt, selector: "", length: 0, toArray: function () {
            return X.call(this)
        }, get: function (e) {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || rt.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)if (null != (o = arguments[a]))for (i in o)e = s[i], n = o[i], s !== n && (c && n && (rt.isPlainObject(n) || (t = rt.isArray(n))) ? (t ? (t = !1, r = e && rt.isArray(e) ? e : []) : r = e && rt.isPlainObject(e) ? e : {}, s[i] = rt.extend(c, r, n)) : void 0 !== n && (s[i] = n));
        return s
    }, rt.extend({
        expando: "jQuery" + (ot + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var n, i, o;
            return "string" == typeof t && (o = e[t], t = e, e = o), rt.isFunction(e) ? (n = X.call(arguments, 2), i = function () {
    ...
    var ut = function (e) {
        function t(e, t, n, i) {
            ...
            if (R && !i) {
                if (o = bt.exec(e))if (s = o[1]) {
                    ...
                    } else if (t.ownerDocument && (r = t.ownerDocument.getElementById(s)) && M(t, r) && r.id === s)return n.push(r), n
                } else {
        ...
        function f(e, t, n) {
            var i = t.dir, o = n && "parentNode" === i, r = z++;
        ...
        function y(e, t, n, o, r, s) {
            return o && !o[H] && (o = y(o)), r && !r[H] && (r = y(r, s)), i(function (i, s, a, l) {
                var c, u, d, h = [], p = [], f = s.length, m = i || _(t || "*", a.nodeType ? [a] : a, []), y = !e || !i && t ? m : g(m, h, e, a, l), b = n ? r || (i ? e : f || o) ? [] : s : y;
        ...
        function b(e) {
            ...
            }]; o > a; a++)if (n = k.relative[e[a].type])u = [f(m(u), n)]; else {
                if (n = k.filter[e[a].type].apply(null, e[a].matches), n[H]) {
                    for (i = ++a; o > i && !k.relative[e[i].type]; i++);
                    return y(a > 1 && m(u), a > 1 && p(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(lt, "$1"), n, i > a && b(e.slice(a, i)), o > i && b(e = e.slice(i)), o > i && p(e))
                }
                u.push(n)
            }
            return m(u)
        ...
        function v(e, n) {
            var o = n.length > 0, r = e.length > 0, s = function (i, s, a, l, c) {
                var u, d, h, p = 0, f = "0", m = i && [], y = [], b = A, v = i || r && k.find.TAG("*", c), _ = B += null == b ? 1 : Math.random() || .1, w = v.length;
                ...
                if (p += f, o && f !== p) {
                    ...
                    if (i) {
                        if (p > 0)for (; f--;)m[f] || y[f] || (y[f] = J.call(l));
                        y = g(y)
                    }
                    Z.apply(l, y), c && !i && y.length > 0 && p + n.length > 1 && t.uniqueSort(l)
                }
                return c && (B = _, A = b), m
            };
            return o ? i(s) : s
        ...
        function w(e, t, n, i) {
            ...
            return E(e, c)(i, t, !R, n, vt.test(e) && u(t.parentNode) || t), n
        }

        var x, C, k, T, S, E, A, N, F, j, O, I, R, D, L, P, M, H = "sizzle" + -new Date, q = e.document, B = 0, z = 0, U = n(), W = n(), V = n(), Q = function (e, t) {
            return e === t && (F = !0), 0
        }, $ = "undefined", G = 1 << 31, X = {}.hasOwnProperty, Y = [], J = Y.pop, K = Y.push, Z = Y.push, et = Y.slice, tt = Y.indexOf || function (e) {
                for (var t = 0, n = this.length; n > t; t++)if (this[t] === e)return t;
                return -1
            }, nt = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", it = "[\\x20\\t\\r\\n\\f]", ot = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", rt = ot.replace("w", "w#"), st = "\\[" + it + "*(" + ot + ")" + it + "*(?:([*^$|!~]?=)" + it + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + rt + ")|)|)" + it + "*\\]", at = ":(" + ot + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + st.replace(3, 8) + ")*)|.*)\\)|)", lt = new RegExp("^" + it + "+|((?:^|[^\\\\])(?:\\\\.)*)" + it + "+$", "g"), ct = new RegExp("^" + it + "*," + it + "*"), ut = new RegExp("^" + it + "*([>+~]|" + it + ")" + it + "*"), dt = new RegExp("=" + it + "*([^\\]'\"]*?)" + it + "*\\]", "g"), ht = new RegExp(at), pt = new RegExp("^" + rt + "$"), ft = {
            ID: new RegExp("^#(" + ot + ")"),
            CLASS: new RegExp("^\\.(" + ot + ")"),
        ...
        }, mt = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i, yt = /^[^{]+\{\s*\[native \w/, bt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, vt = /[+~]/, _t = /'|\\/g, wt = new RegExp("\\\\([\\da-f]{1,6}" + it + "?|(" + it + ")|.)", "ig"), xt = function (e, t, n) {
            var i = "0x" + t - 65536;
        ...
        C = t.support = {}, S = t.isXML = function (e) {
            ...
            return n !== O && 9 === n.nodeType && n.documentElement ? (O = n, I = n.documentElement, R = !S(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function () {
                ...
                return typeof t.getElementsByClassName !== $ && R ? t.getElementsByClassName(e) : void 0
                ...
                C.disconnectedMatch = P.call(e, "div"), P.call(e, "[s!='']:x"), L.push("!=", at)
            }), D = D.length && new RegExp(D.join("|")), L = L.length && new RegExp(L.join("|")), t = yt.test(I.compareDocumentPosition), M = t || yt.test(I.contains) ? function (e, t) {
            ...
            var n = k.attrHandle[t.toLowerCase()], i = n && X.call(k.attrHandle, t.toLowerCase()) ? n(e, t, !R) : void 0;
            return void 0 !== i ? i : C.attributes || !R ? e.getAttribute(t) : (i = e.getAttributeNode(t)) && i.specified ? i.value : null
        }, t.error = function (e) {
            throw new Error("Syntax error, unrecognized expression: " + e)
        }, t.uniqueSort = function (e) {
            var t, n = [], i = 0, o = 0;
            if (F = !C.detectDuplicates, N = !C.sortStable && e.slice(0), e.sort(Q), F) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === o ? function (e) {
                        ...
                        var c, u, d, h, p, f, m = r !== s ? "nextSibling" : "previousSibling", g = t.parentNode, y = a && t.nodeName.toLowerCase(), b = !l && !a;
                        if (g) {
                            if (r) {
                                for (; m;) {
                            ...
                            } else if (b && (c = (t[H] || (t[H] = {}))[e]) && c[0] === B)h = c[1]; else for (; (d = ++p && d && d[m] || (h = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++h || (b && ((d[H] || (d[H] = {}))[e] = [B, h]), d !== t)););
        ...
        return d.prototype = k.filters = k.pseudos, k.setFilters = new d, E = t.compile = function (e, t) {
            var n, i = [], o = [], r = V[e + " "];
            if (!r) {
                for (t || (t = h(e)), n = t.length; n--;)r = b(t[n]), r[H] ? i.push(r) : o.push(r);
                r = V(e, v(o, i))
            }
            return r
        }, C.sortStable = H.split("").sort(Q).join("") === H, C.detectDuplicates = !!F, j(), C.sortDetached = o(function (e) {
    ...
    var ft, mt = e.document, gt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, yt = rt.fn.init = function (e, t) {
        var n, i;
        if (!e)return this;
        if ("string" == typeof e) {
    ...
    rt.extend({
        ...
        rt.fn[e] = function (n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = rt.filter(i, o)), this.length > 1 && (vt[e] || (o = rt.unique(o)), bt.test(e) && (o = o.reverse())), this.pushStack(o)
        }
    });
    var _t = /\S+/g, wt = {};
    rt.Callbacks = function (e) {
        ...
        var t, n, i, o, s, a, l = [], c = !e.once && [], u = function (r) {
            ...
            add: function () {
                ...
                return l && rt.each(arguments, function (e, n) {
                    for (var i; (i = rt.inArray(n, l, i)) > -1;)l.splice(i, 1), t && (o >= i && o--, s >= i && s--)
                }), this
            }, has: function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, i, o = 0, r = X.call(arguments), s = r.length, a = 1 !== s || e && rt.isFunction(e.promise) ? s : 0, l = 1 === a ? e : rt.Deferred(), c = function (e, n, i) {
                return function (o) {
    ...
    var Et = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, At = ["Top", "Right", "Bottom", "Left"], Nt = function (e, t) {
    ...
    var Ot = /^(?:input|select|textarea)$/i, It = /^key/, Rt = /^(?:mouse|contextmenu)|click/, Dt = /^(?:focusinfocus|focusoutblur)$/, Lt = /^([^.]*)(?:\.(.+)|)$/;
    rt.event = {
        global: {},
        add: function (e, t, n, i, o) {
            ...
            if (g) {
                ...
                }, u.elem = e), t = (t || "").match(_t) || [""], a = t.length; a--;)r = Lt.exec(t[a]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p && (c = rt.event.special[p] || {}, p = (o ? c.delegateType : c.bindType) || p, c = rt.event.special[p] || {}, d = rt.extend({
                    type: p,
                    origType: m,
                    data: i,
                    handler: n,
        ...
        remove: function (e, t, n, i, o) {
            ...
            if (g && (u = g.events)) {
                for (t = (t || "").match(_t) || [""], c = t.length; c--;)if (a = Lt.exec(t[c]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                    for (d = rt.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, h = u[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = h.length; r--;)s = h[r], !o && m !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (h.splice(r, 1), s.selector && h.delegateCount--, d.remove && d.remove.call(e, s));
        ...
        trigger: function (t, n, i, o) {
            var r, s, a, l, c, u, d, h = [i || mt], p = tt.call(t, "type") ? t.type : t, f = tt.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = u = i = i || mt, 3 !== i.nodeType && 8 !== i.nodeType && !Dt.test(p + rt.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), s = p.indexOf(":") < 0 && "on" + p, t = t[rt.expando] ? t : new rt.Event(p, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : rt.makeArray(n, [t]), c = rt.event.special[p] || {}, o || !c.trigger || c.trigger.apply(i, n) !== !1)) {
                if (!o && !c.noBubble && !rt.isWindow(i)) {
                    for (l = c.delegateType || p, Dt.test(l + p) || (a = a.parentNode); a; a = a.parentNode)h.push(a), u = a;
                ...
                if (t.type = p, !o && !t.isDefaultPrevented() && (!c._default || c._default.apply(h.pop(), n) === !1) && rt.acceptData(i) && s && i[p] && !rt.isWindow(i)) {
                    u = i[s], u && (i[s] = null), rt.event.triggered = p;
                    try {
                        i[p]()
                    } catch (m) {
                    }
        ...
        dispatch: function (e) {
            e = rt.event.fix(e);
            var t, n, i, o, r, s = [], a = X.call(arguments), l = (rt._data(this, "events") || {})[e.type] || [], c = rt.event.special[e.type] || {};
        ...
        fix: function (e) {
            ...
            for (s || (this.fixHooks[o] = s = Rt.test(o) ? this.mouseHooks : It.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new rt.Event(r), t = i.length; t--;)n = i[t], e[n] = r[n];
        ...
        simulate: function (e, t, n, i) {
            var o = rt.extend(new rt.Event, n, {type: e, isSimulated: !0, originalEvent: {}});
    ...
    }), it.focusinBubbles || rt.each({focus: "focusin", blur: "focusout"}, function (e, t) {
        var n = function (e) {
            rt.event.simulate(t, e.target, rt.event.fix(e), !0)
        };
        rt.event.special[t] = {
            setup: function () {
                var i = this.ownerDocument || this, o = rt._data(i, t);
                o || i.addEventListener(e, n, !0), rt._data(i, t, (o || 0) + 1)
            }, teardown: function () {
                var i = this.ownerDocument || this, o = rt._data(i, t) - 1;
    ...
    var Pt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", Mt = / jQuery\d+="(?:null|\d+)"/g, Ht = new RegExp("<(?:" + Pt + ")[\\s/>]", "i"), qt = /^\s+/, Bt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, zt = /<([\w:]+)/, Ut = /<tbody/i, Wt = /<|&#?\w+;/, Vt = /<(?:script|style|link)/i, Qt = /checked\s*(?:[^=]|=\s*.checked.)/i, $t = /^$|\/(?:java|ecma)script/i, Gt = /^true\/(.*)/, Xt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Yt = {
    ...
    }, Jt = m(mt), Kt = Jt.appendChild(mt.createElement("div"));
    Yt.optgroup = Yt.option, Yt.tbody = Yt.tfoot = Yt.colgroup = Yt.caption = Yt.thead, Yt.th = Yt.td, rt.extend({
        clone: function (e, t, n) {
            ...
            if (it.html5Clone || rt.isXMLDoc(e) || !Ht.test("<" + e.nodeName + ">") ? r = e.cloneNode(!0) : (Kt.innerHTML = e.outerHTML, Kt.removeChild(r = Kt.firstChild)), !(it.noCloneEvent && it.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || rt.isXMLDoc(e)))for (i = g(r), a = g(e), s = 0; null != (o = a[s]); ++s)i[s] && C(o, i[s]);
            if (t)if (n)for (a = a || g(e), i = i || g(r), s = 0; null != (o = a[s]); s++)x(o, i[s]); else x(e, r);
            return i = g(r, "script"), i.length > 0 && w(i, !l && g(e, "script")), i = a = o = null, r
        }, buildFragment: function (e, t, n, i) {
            for (var o, r, s, a, l, c, u, d = e.length, h = m(t), p = [], f = 0; d > f; f++)if (r = e[f], r || 0 === r)if ("object" === rt.type(r))rt.merge(p, r.nodeType ? [r] : r); else if (Wt.test(r)) {
                for (a = a || h.appendChild(t.createElement("div")), l = (zt.exec(r) || ["", ""])[1].toLowerCase(), u = Yt[l] || Yt._default, a.innerHTML = u[1] + r.replace(Bt, "<$1></$2>") + u[2], o = u[0]; o--;)a = a.lastChild;
            ...
            for (a && h.removeChild(a), it.appendChecked || rt.grep(g(p, "input"), y), f = 0; r = p[f++];)if ((!i || -1 === rt.inArray(r, i)) && (s = rt.contains(r.ownerDocument, r), a = g(h.appendChild(r), "script"), s && w(a), n))for (o = 0; r = a[o++];)$t.test(r.type || "") && n.push(r);
            return a = null, h
        }, cleanData: function (e, t) {
            for (var n, i, o, r, s = 0, a = rt.expando, l = rt.cache, c = it.deleteExpando, u = rt.event.special; null != (n = e[s]); s++)if ((t || rt.acceptData(n)) && (o = n[a], r = o && l[o])) {
                if (r.events)for (i in r.events)u[i] ? rt.event.remove(n, i) : rt.removeEvent(n, i, r.handle);
                l[o] && (delete l[o], c ? delete n[a] : typeof n.removeAttribute !== kt ? n.removeAttribute(a) : n[a] = null, G.push(o))
            }
        }
    }), rt.fn.extend({
        text: function (e) {
            ...
            for (var n, i = e ? rt.filter(e, this) : this, o = 0; null != (n = i[o]); o++)t || 1 !== n.nodeType || rt.cleanData(g(n)), n.parentNode && (t && rt.contains(n.ownerDocument, n) && w(g(n, "script")), n.parentNode.removeChild(n));
            return this
        }, empty: function () {
            ...
            return Ft(this, function (e) {
                ...
                if (!("string" != typeof e || Vt.test(e) || !it.htmlSerialize && Ht.test(e) || !it.leadingWhitespace && qt.test(e) || Yt[(zt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Bt, "<$1></$2>");
                    try {
            ...
            e = Y.apply([], e);
            var n, i, o, r, s, a, l = 0, c = this.length, u = this, d = c - 1, h = e[0], p = rt.isFunction(h);
            if (p || c > 1 && "string" == typeof h && !it.checkClone && Qt.test(h))return this.each(function (n) {
                var i = u.eq(n);
            ...
            if (c && (a = rt.buildFragment(e, this[0].ownerDocument, !1, this), n = a.firstChild, 1 === a.childNodes.length && (a = n), n)) {
                for (r = rt.map(g(a, "script"), v), o = r.length; c > l; l++)i = a, l !== d && (i = rt.clone(i, !0, !0), o && rt.merge(r, g(i, "script"))), t.call(this[l], i, l);
                if (o)for (s = r[r.length - 1].ownerDocument, rt.map(r, _), l = 0; o > l; l++)i = r[l], $t.test(i.type || "") && !rt._data(i, "globalEval") && rt.contains(s, i) && (i.src ? rt._evalUrl && rt._evalUrl(i.src) : rt.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Xt, "")));
                a = n = null
            }
            return this
        }
        ...
        rt.fn[e] = function (e) {
            for (var n, i = 0, o = [], r = rt(e), s = r.length - 1; s >= i; i++)n = i === s ? this : this.clone(!0), rt(r[i])[t](n), J.apply(o, n.get());
    ...
    !function () {
        ...
        n.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", e = n.getElementsByTagName("a")[0], e.style.cssText = "float:left;opacity:.5", it.opacity = /^0.5/.test(e.style.opacity), it.cssFloat = !!e.style.cssFloat, n.style.backgroundClip = "content-box", n.cloneNode(!0).style.backgroundClip = "", it.clearCloneStyle = "content-box" === n.style.backgroundClip, e = n = null, it.shrinkWrapBlocks = function () {
            ...
            if (null == t) {
                ...
                r = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px", n = mt.createElement("div"), o = mt.createElement("div"), e.appendChild(n).appendChild(o), t = !1, typeof o.style.zoom !== kt && (o.style.cssText = i + ";width:1px;padding:1px;zoom:1", o.innerHTML = "<div></div>", o.firstChild.style.width = "5px", t = 3 !== o.offsetWidth), e.removeChild(n), e = n = o = null
            }
            return t
        }
    }();
    var tn, nn, on = /^margin/, rn = new RegExp("^(" + Et + ")(?!px)[a-z%]+$", "i"), sn = /^(top|right|bottom|left)$/;
    e.getComputedStyle ? (tn = function (e) {
        ...
        var n, i, o, r, s, a, l = mt.createElement("div"), c = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px", u = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0";
        l.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", n = l.getElementsByTagName("a")[0], n.style.cssText = "float:left;opacity:.5", it.opacity = /^0.5/.test(n.style.opacity), it.cssFloat = !!n.style.cssFloat, l.style.backgroundClip = "content-box", l.cloneNode(!0).style.backgroundClip = "", it.clearCloneStyle = "content-box" === l.style.backgroundClip, n = l = null, rt.extend(it, {
            reliableHiddenOffsets: function () {
                if (null != i)return i;
                var e, t, n, o = mt.createElement("div"), r = mt.getElementsByTagName("body")[0];
                ...
                if (null == a && e.getComputedStyle) {
                    ...
                    n = mt.createElement("div"), i = mt.createElement("div"), n.style.cssText = c, t.appendChild(n).appendChild(i), o = i.appendChild(mt.createElement("div")), o.style.cssText = i.style.cssText = u, o.style.marginRight = o.style.width = "0", i.style.width = "1px", a = !parseFloat((e.getComputedStyle(o, null) || {}).marginRight), t.removeChild(n)
                }
                return a
            }
        })
    ...
    var an = /alpha\([^)]*\)/i, ln = /opacity\s*=\s*([^)]*)/, cn = /^(none|table(?!-c[ea]).+)/, un = new RegExp("^(" + Et + ")(.*)$", "i"), dn = new RegExp("^([+-])=(" + Et + ")", "i"), hn = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    ...
    rt.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = rt.camelCase(t), l = e.style;
        ...
        css: function (e, t, n, i) {
            ...
            return t = rt.cssProps[a] || (rt.cssProps[a] = E(e.style, a)), s = rt.cssHooks[t] || rt.cssHooks[a], s && "get"in s && (r = s.get(e, !0, n)), void 0 === r && (r = nn(e, t, i)), "normal" === r && t in pn && (r = pn[t]), "" === n || n ? (o = parseFloat(r), n === !0 || rt.isNumeric(o) ? o || 0 : r) : r
        }
        ...
        get: function (e, t) {
            ...
            var n = e.style, i = e.currentStyle, o = rt.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "", r = i && i.filter || n.filter || "";
        ...
        constructor: O, init: function (e, t, n, i, o, r) {
            ...
            return this.pos = t = this.options.duration ? rt.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : O.propHooks._default.set(this), this
        }
    ...
    var mn, gn, yn = /^(?:toggle|show|hide)$/, bn = new RegExp("^(?:([+-])=|)(" + Et + ")([a-z%]*)$", "i"), vn = /queueHooks$/, _n = [L], wn = {
        "*": [function (e, t) {
            var n = this.createTween(e, t), i = n.cur(), o = bn.exec(t), r = o && o[3] || (rt.cssNumber[e] ? "" : "px"), s = (rt.cssNumber[e] || "px" !== r && +i) && bn.exec(rt.css(n.elem, e)), a = 1, l = 20;
            if (s && s[3] !== r) {
                r = r || s[3], o = o || [], s = +i || 1;
    ...
    rt.Animation = rt.extend(M, {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                var t = !0, o = null != e && e + "queueHooks", r = rt.timers, s = rt._data(this);
                if (o)s[o] && s[o].stop && i(s[o]); else for (o in s)s[o] && s[o].stop && vn.test(o) && i(s[o]);
                for (o = r.length; o--;)r[o].elem !== this || null != e && r[o].queue !== e || (r[o].anim.stop(n), t = !1, r.splice(o, 1));
                (t || !n) && rt.dequeue(this, e)
            })
        }, finish: function (e) {
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = rt._data(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = rt.timers, s = i ? i.length : 0;
    ...
    rt.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, i = e.options, o = e.selectedIndex, r = "select-one" === e.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)if (n = i[l], !(!n.selected && l !== o || (it.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && rt.nodeName(n.parentNode, "optgroup"))) {
                        if (t = rt(n).val(), r)return t;
                        s.push(t)
                    }
                    return s
                }, set: function (e, t) {
                    for (var n, i, o = e.options, r = rt.makeArray(t), s = o.length; s--;)if (i = o[s], rt.inArray(rt.valHooks.option.get(i), r) >= 0)try {
                        i.selected = n = !0
                    } catch (a) {
                        i.scrollHeight
                    } else i.selected = !1;
    ...
    var Cn, kn, Tn = rt.expr.attrHandle, Sn = /^(?:checked|selected)$/i, En = it.getSetAttribute, An = it.input;
    rt.fn.extend({
        attr: function (e, t) {
        ...
        attr: function (e, t, n) {
            ...
            var n, i, o = 0, r = t && t.match(_t);
            if (r && 1 === e.nodeType)for (; n = r[o++];)i = rt.propFix[n] || n, rt.expr.match.bool.test(n) ? An && En || !Sn.test(n) ? e[i] = !1 : e[rt.camelCase("default-" + n)] = e[i] = !1 : rt.attr(e, n, ""), e.removeAttribute(En ? n : i)
        }, attrHooks: {
            type: {
                set: function (e, t) {
        ...
        set: function (e, t, n) {
            return t === !1 ? rt.removeAttr(e, n) : An && En || !Sn.test(n) ? e.setAttribute(!En && rt.propFix[n] || n, n) : e[rt.camelCase("default-" + n)] = e[n] = !0, n
        }
    ...
    var Nn = /^(?:input|select|textarea|button|object)$/i, Fn = /^(?:a|area)$/i;
    rt.fn.extend({
        prop: function (e, t) {
    ...
    rt.fn.extend({
        addClass: function (e) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(rt.isFunction(e) ? function (n) {
                ...
                if ("string" === n)for (var t, i = 0, o = rt(this), r = e.match(_t) || []; t = r[i++];)o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else(n === kt || "boolean" === n) && (this.className && rt._data(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : rt._data(this, "__className__") || "")
            })
        }, hasClass: function (e) {
    ...
    rt.parseJSON = function (t) {
        ...
        var n, i = null, o = rt.trim(t + "");
        return o && !rt.trim(o.replace(Rn, function (e, t, o, r) {
    ...
    var Dn, Ln, Pn = /#.*$/, Mn = /([?&])_=[^&]*/, Hn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, qn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Bn = /^(?:GET|HEAD)$/, zn = /^\/\//, Un = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Wn = {}, Vn = {}, Qn = "*/".concat("*");
    try {
        Ln = location.href
    } catch ($n) {
        Ln = mt.createElement("a"), Ln.href = "", Ln = Ln.href
    }
    Dn = Un.exec(Ln.toLowerCase()) || [], rt.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (e, t) {
            ...
            var i, o, r, s, a, l, c, u, d = rt.ajaxSetup({}, t), h = d.context || d, p = d.context && (h.nodeType || h.jquery) ? rt(h) : rt.event, f = rt.Deferred(), m = rt.Callbacks("once memory"), g = d.statusCode || {}, y = {}, b = {}, v = 0, _ = "canceled", w = {
                readyState: 0,
                ...
                setRequestHeader: function (e, t) {
                    var n = e.toLowerCase();
                    return v || (e = b[n] = b[n] || e, y[e] = t), this
                },
            ...
            l = d.global, l && 0 === rt.active++ && rt.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Bn.test(d.type), r = d.url, d.hasContent || (d.data && (r = d.url += (In.test(r) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Mn.test(r) ? r.replace(Mn, "$1_=" + On++) : r + (In.test(r) ? "&" : "?") + "_=" + On++)), d.ifModified && (rt.lastModified[r] && w.setRequestHeader("If-Modified-Since", rt.lastModified[r]), rt.etag[r] && w.setRequestHeader("If-None-Match", rt.etag[r])), (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Qn + "; q=0.01" : "") : d.accepts["*"]);
    ...
    rt.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !rt(this).is(":disabled") && Kn.test(this.nodeName) && !Jn.test(e) && (this.checked || !jt.test(e))
            }).map(function (e, t) {
                var n = rt(this).val();
    ...
    var Zn = 0, ei = {}, ti = rt.ajaxSettings.xhr();
            ...
            return {
                send: function (n, i) {
                    ...
                    r.send(e.hasContent && e.data || null), t = function (n, o) {
                        var a, l, c;
                        if (t && (o || 4 === r.readyState))if (delete ei[s], t = void 0, r.onreadystatechange = rt.noop, o)4 !== r.readyState && r.abort(); else {
    ...
    rt.offset = {
        setOffset: function (e, t, n) {
            ...
            "static" === u && (e.style.position = "relative"), a = d.offset(), r = rt.css(e, "top"), l = rt.css(e, "left"), c = ("absolute" === u || "fixed" === u) && rt.inArray("auto", [r, l]) > -1, c ? (i = d.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), rt.isFunction(t) && (t = t.call(e, n, a)), null != t.top && (h.top = t.top - a.top + s), null != t.left && (h.left = t.left - a.left + o), "using"in t ? t.using.call(e, h) : d.css(h)
        }
    }, rt.fn.extend({
        offset: function (e) {
            ...
            return r ? (t = r.documentElement, rt.contains(t, o) ? (typeof o.getBoundingClientRect !== kt && (i = o.getBoundingClientRect()), n = $(r), {
    ...
    e.rails = n = {
        ...
        handleRemote: function (i) {
            ...
            if (n.fire(i, "ajax:before")) {
                ...
                d = {
                    type: o || "GET", data: s, dataType: u, beforeSend: function (e, o) {
        ...
        handleMethod: function (i) {
            var o = n.href(i), r = i.data("method"), s = i.attr("target"), a = e("meta[name=csrf-token]").attr("content"), l = e("meta[name=csrf-param]").attr("content"), c = e('<form method="post" action="' + o + '"></form>'), u = '<input name="_method" value="' + r + '" type="hidden" />';
        ...
        blankInputs: function (t, n, i) {
            var o, r, s = e(), a = n || "input,textarea", l = t.find(a);
        ...
        var o = e(this), r = o.data("method"), s = o.data("params");
        ...
        var o = e(this), r = o.data("remote") !== t, s = n.blankInputs(o, n.requiredInputSelector), a = n.nonBlankInputs(o, n.fileInputSelector);
        if (!n.allowAction(o))return n.stopEverything(i);
    ...
    var s = /\+/g, a = e.cookie = function (o, s, l) {
        ...
        for (var d = o ? void 0 : {}, h = document.cookie ? document.cookie.split("; ") : [], p = 0, f = h.length; f > p; p++) {
            var m = h[p].split("="), g = n(m.shift()), y = m.join("=");
            if (o && o === g) {
                d = r(y, s);
                break
            }
    ...
    var Faye = {
        ...
        map: function (e, t, n) {
            ...
            var i = [];
            if (e instanceof Array)for (var o = 0, r = e.length; r > o; o++)i.push(t.call(n || null, e[o], o)); else for (var s in e)e.hasOwnProperty(s) && i.push(t.call(n || null, s, e[s]));
            return i
        },
        ...
        asyncEach: function (e, t, n, i) {
            var o = e.length, r = -1, s = 0, a = !1, l = function () {
                return s -= 1, r += 1, r === o ? n && n.call(i) : void t(e[r], u)
            }, c = function () {
                if (!a) {
                    for (a = !0; s > 0;)l();
                    a = !1
    ...
    "undefined" != typeof module ? module.exports = Faye : "undefined" != typeof window && (window.Faye = Faye), Faye.Class = function (e, t) {
        ...
        t.prototype.emit = function (e) {
            ...
            if (n(o)) {
                var r = e(o, i);
                if (0 > r)return this;
                o.splice(r, 1), 0 == o.length && delete this._events[t]
        ...
        var l = function (t, o, s) {
            ...
            if (e._state === n) {
                e._state = o, e._reason = t, e._callbacks = [];
                for (var i, r = e._errbacks; i = r.shift();)i(t)
            }
        };
        a.defer = e, a.pending = function () {
            var e = {};
            return e.promise = new a(function (t, n) {
                e.fulfill = t, e.reject = n
            }), e
        ...
        isURI: function (e) {
            ...
            var t, n, i, o, r, s, a = {}, l = function (t, n) {
                e = e.replace(n, function (e) {
                    return a[t] = e, ""
                }), a[t] = a[t] || ""
            };
            for (l("protocol", /^[a-z]+\:/i), l("host", /^\/\/[^\/\?#]+/), /^\//.test(e) || a.host || (e = Faye.ENV.location.pathname.replace(/[^\/]*$/, "") + e), l("pathname", /^[^\?#]*/), l("search", /^\?[^#]*/), l("hash", /^#.*/), a.protocol = a.protocol || Faye.ENV.location.protocol, a.host ? (a.host = a.host.substr(2), t = a.host.split(":"), a.hostname = t[0], a.port = t[1] || "") : (a.host = Faye.ENV.location.host, a.hostname = Faye.ENV.location.hostname, a.port = Faye.ENV.location.port), a.pathname = a.pathname || "/", a.path = a.pathname + a.search, n = a.search.replace(/^\?/, ""), i = n ? n.split("&") : [], s = {}, o = 0, r = i.length; r > o; o++)t = i[o].split("="), s[decodeURIComponent(t[0] || "")] = decodeURIComponent(t[1] || "");
        ...
        countListeners: function (e) {
            ...
            var i = Array.prototype.slice, o = function () {
                t.apply(n, i.call(arguments))
            };
            return this._listeners = this._listeners || [], this._listeners.push([e, t, n, o]), this.on(e, o)
        }, unbind: function (e, t, n) {
            this._listeners = this._listeners || [];
            for (var i, o = this._listeners.length; o--;)i = this._listeners[o], i[0] === e && (!t || i[1] === t && i[2] === n) && (this._listeners.splice(o, 1), this.removeListener(e, i[3]))
        }
        ...
        LOG_LEVELS: {fatal: 4, error: 3, warn: 2, info: 1, debug: 0}, writeLog: function (e, t) {
            if (Faye.logger) {
                var e = Array.prototype.slice.apply(e), n = "[Faye", i = this.className, o = e.shift().replace(/\?/g, function () {
                    try {
                ...
                i && (n += "." + i), n += "] ", "function" == typeof Faye.logger[t] ? Faye.logger[t](n + o) : "function" == typeof Faye.logger && Faye.logger(n + o)
            }
        }
    }, function () {
        ...
        addExtension: function (e) {
            ...
            var r = this._extensions.slice(), s = function (t) {
        ...
        expand: function (e) {
            ...
            for (var o = 1, r = t.length; r > o; o++)i = t.slice(0, o), i.push("**"), n.push(this.unparse(i));
            return n
        },
        isValid: function (e) {
        ...
        Set: Faye.Class({
            initialize: function () {
                ...
                if (t)for (var i, o = 0, r = e.length; r > o; o++) {
                    i = e[o];
        ...
        subscribe: function (e, t, n) {
            ...
            var i = new Faye.Subscription(this, e, t, n), o = t === !0, r = this._channels.hasSubscription(e);
            return r && !o ? (this._channels.subscribe([e], t, n), i.setDeferredStatus("succeeded"), i) : (this.connect(function () {
                this.info("Client ? attempting to subscribe to ?", this._clientId, e), o || this._channels.subscribe([e], t, n), this._send({
                    channel: Faye.Channel.SUBSCRIBE,
                    clientId: this._clientId,
                    subscription: e
                }, function (o) {
                    if (!o.successful)return i.setDeferredStatus("failed", Faye.Error.parse(o.error)), this._channels.unsubscribe(e, t, n);
        ...
        messageError: function (e, t) {
            for (var n, i, o = this._retry, r = this, s = 0, a = e.length; a > s; s++)i = e[s], n = i.id, t ? this._transportSend(i) : Faye.ENV.setTimeout(function () {
                r._transportSend(i)
            }, 1e3 * o);
        ...
        _transportSend: function (e) {
            if (this._transport) {
                var t = 1.2 * (this._advice.timeout || 1e3 * this._retry), n = new Faye.Envelope(e, t);
        ...
        flush: function () {
            this.removeTimeout("publish"), this._outbox.length > 1 && this._connectMessage && (this._connectMessage.advice = {timeout: 0}), this.request(this._outbox), this._connectMessage = null, this._outbox = []
        },
        ...
        get: function (e, t, n, i, o) {
            var r = e.endpoint;
            Faye.asyncEach(this._transports, function (s, a) {
                var l = s[0], c = s[1], u = e.endpoints[l] || r;
                return Faye.indexOf(n, l) >= 0 ? a() : Faye.indexOf(t, l) < 0 ? (c.isUsable(e, u, function () {
                }), a()) : void c.isUsable(e, u, function (t) {
                    if (!t)return a();
        ...
        _registry: [], on: function (e, t, n, i) {
            ...
            for (var o, r = this._registry.length; r--;)o = this._registry[r], e && e !== o._element || t && t !== o._type || n && n !== o._callback || i && i !== o._context || (o._element.removeEventListener ? o._element.removeEventListener(o._type, o._handler, !1) : o._element.detachEvent("on" + o._type, o._handler), this._registry.splice(r, 1), o = null)
        }
        ...
        function str(e, t) {
            ...
            switch (l && "object" == typeof l && "function" == typeof l.toJSON && (l = l.toJSON(e)), "function" == typeof rep && (l = rep.call(t, e, l)), typeof l) {
                ...
                case"object":
                    ...
                    if (rep && "object" == typeof rep)for (r = rep.length, n = 0; r > n; n += 1)"string" == typeof rep[n] && (i = rep[n], o = str(i, l), o && s.push(quote(i) + (gap ? ": " : ":") + o)); else for (i in l)Object.prototype.hasOwnProperty.call(l, i) && (o = str(i, l), o && s.push(quote(i) + (gap ? ": " : ":") + o));
                    return o = 0 === s.length ? "{}" : gap ? "{\n" + gap + s.join(",\n" + gap) + "\n" + a + "}" : "{" + s.join(",") + "}", gap = a, o
            }
        }
        ...
        request: function (e) {
            this.callback(function (t) {
                if (t) {
                    for (var n = 0, i = e.length; i > n; n++)this._pending.add(e[n]);
                    var o = Faye.map(e, function (e) {
                        return e.message
                    });
        ...
        connect: function () {
            if (!Faye.Transport.WebSocket._unloaded && (this._state = this._state || this.UNCONNECTED, this._state === this.UNCONNECTED)) {
                ...
                var t = this;
                e.onopen = function () {
                    e.headers && t._storeCookies(e.headers["set-cookie"]), t._socket = e, t._pending = new Faye.Set, t._state = t.CONNECTED, t._everConnected = !0, t._ping(), t.setDeferredStatus("succeeded", e)
                };
                var n = !1;
                e.onclose = e.onerror = function () {
                    if (!n) {
                        ...
                        delete t._pending, i ? t.handleError(o, !0) : t._everConnected ? t.handleError(o) : t.setDeferredStatus("failed")
                    }
                }, e.onmessage = function (e) {
                    var n, i = JSON.parse(e.data), o = [];
                    if (i) {
                        i = [].concat(i);
                        for (var r = 0, s = i.length; s > r; r++)void 0 !== i[r].successful && (n = t._pending.remove(i[r]), n && o.push(n));
                        t.receive(o, i)
                    }
                }
            }
        ...
        _createSocket: function () {
            var e = Faye.Transport.WebSocket.getSocketUrl(this.endpoint), t = {
        ...
        isUsable: function (e, t, n, i) {
            ...
            var n = e.transports.eventsource = e.transports.eventsource || {}, i = e._clientId;
            t = Faye.copyObject(t), t.pathname += "/" + (i || "");
            var o = Faye.URI.stringify(t);
            return n[o] = n[o] || new this(e, t), n[o]
        }
        ...
        encode: function (e) {
            ...
            var t = this.endpoint.path, n = Faye.ENV.ActiveXObject ? new ActiveXObject("Microsoft.XMLHTTP") : new XMLHttpRequest, i = this;
            ...
            Faye.Event.on(Faye.ENV, "beforeunload", s), n.onreadystatechange = function () {
                if (n && 4 === n.readyState) {
                    var t = null, o = n.status, r = n.responseText, a = o >= 200 && 300 > o || 304 === o || 1223 === o;
        ...
        encode: function (e) {
            ...
            var t, n = Faye.ENV.XDomainRequest ? XDomainRequest : XMLHttpRequest, i = new n, o = this._client.headers, r = this;
            ...
            i.onload = function () {
                ...
                s(), t ? r.receive(e, t) : r.handleError(e)
        ...
        encode: function (e) {
            ...
            var t = Faye.map(e, function (e) {
                return e.message
            }), n = document.getElementsByTagName("head")[0], i = document.createElement("script"), o = Faye.Transport.JSONP.getCallbackName(), r = Faye.copyObject(this.endpoint), s = this;
            r.query.message = Faye.toJSON(t), r.query.jsonp = o, Faye.ENV[o] = function (t) {
                ...
                i.parentNode.removeChild(i), s.receive(e, t)
    ...
    function p(t) {
        ...
        return A.text(t.val()), A.width()
    }

    function f(e, t, n, i) {
        var o = e.toUpperCase().indexOf(t.toUpperCase()), r = t.length;
    ...
    function m(t) {
        var n, i = 0, o = null, r = t.quietMillis || 100;
        return function (s) {
            window.clearTimeout(n), n = window.setTimeout(function () {
                i += 1;
                var n = i, r = t.data, a = t.transport || e.ajax, l = t.traditional || !1, c = t.type || "GET";
                r = r.call(this, s.term, s.page, s.context), null !== o && o.abort(), o = a.call(null, {
    ...
    function g(t) {
        var n, i = t, o = function (e) {
            return "" + e.text
        };
        return e.isArray(i) || (o = i.text, e.isFunction(o) || (n = i.text, o = function (e) {
            return e[n]
        }), i = i.results), function (t) {
            var n, r = t.term, s = {results: []};
            return "" === r ? void t.callback({results: i}) : (n = function (i, s) {
                var a, l;
                if (i = i[0], i.children) {
                    a = {};
                    for (l in i)i.hasOwnProperty(l) && (a[l] = i[l]);
                    a.children = [], e(i.children).each2(function (e, t) {
                        n(t, a.children)
    ...
    function y(n) {
        return e.isFunction(n) ? n : function (i) {
            var o = i.term, r = {results: []};
            e(n).each(function () {
                var e = this.text !== t, n = e ? this.text : this;
                ("" === o || i.matcher(o, n)) && r.results.push(e ? this : {id: this, text: this})
            }), i.callback(r)
        }
    }
    ...
    if (window.Select2 === t) {
        ...
        C = {
            ...
            F.bind("mousedown touchend", function (n) {
                var i, o = e(n.target).closest("div.select2-container").get(0), r = null;
                o && (F.find("div.select2-container-active").each(function () {
                    this !== o && e(this).data("select2").blur()
                }), r = e(o).data("select2").dropdown.get(0)), o = r || e(n.target).closest("div.select2-drop").get(0), F.find("div.select2-drop-active").each(function () {
                    this !== o && e(this).data("select2").blur()
                }), o = e(n.target), i = o.attr("for"), "LABEL" === n.target.tagName && i && i.length > 0 && (i = i.replace(/([\[\].])/g, "\\$1"), o = e("#" + i), o = o.data("select2"), o !== t && (o.focus(), n.preventDefault()))
            })
        }), k = x(Object, {
            bind: function (e) {
                var t = this;
                ...
                this.opts = n = this.prepareOpts(n), this.id = n.id, n.element.data("select2") !== t && null !== n.element.data("select2") && this.destroy(), this.enabled = !0, this.container = this.createContainer(), this.containerId = "s2id_" + (n.element.attr("id") || "autogen" + E()), this.containerSelector = "#" + this.containerId.replace(/([;&,\.\+\*\~':"\!\^#$%@\[\]\(\)=>\|])/g, "\\$1"), this.container.attr("id", this.containerId), this.body = c(function () {
                    return n.element.closest("body")
                }), n.element.attr("class") !== t && this.container.addClass(n.element.attr("class").replace(/validate\[[\S ]+] ?/, "")), this.container.css(v(n.containerCss)), this.container.addClass(v(n.containerCssClass)), this.opts.element.data("select2", this).hide().before(this.container), this.container.data("select2", this), this.dropdown = this.container.find(".select2-drop"), this.dropdown.addClass(v(n.dropdownCssClass)), this.dropdown.data("select2", this), this.results = i = this.container.find(r), this.search = o = this.container.find("input.select2-input"), o.attr("tabIndex", this.opts.element.attr("tabIndex")), this.resultsPage = 0, this.context = null, this.initContainer(), this.initContainerWidth(), a(this.results), this.dropdown.delegate(r, "mousemove-filtered", this.bind(this.highlightUnderEvent)), u(80, this.results), this.dropdown.delegate(r, "scroll-debounced", this.bind(this.loadMoreIfNeeded)), e.fn.mousewheel && i.mousewheel(function (e, t, n, o) {
                    var r = i.scrollTop();
                ...
                }), s(o), o.bind("keyup-change", this.bind(this.updateResults)), o.bind("focus", function () {
                    o.addClass("select2-focused"), " " === o.val() && o.val("")
                ...
                if (r = n.element, "select" === r.get(0).tagName.toLowerCase() && (this.select = s = n.element), s && e.each(["id", "multiple", "ajax", "query", "createSearchChoice", "initSelection", "data", "tags"], function () {
                        ...
                        populateResults: function (i, o, r) {
                            ...
                            (s = function (i, o, c) {
                                ...
                                for (i = n.sortResults(i, o, r), u = 0, d = i.length; d > u; u += 1)h = i[u], f = h.disabled === !0, p = !f && a(h) !== t, m = h.children && h.children.length > 0, g = e("<li></li>"), g.addClass("select2-results-dept-" + c), g.addClass("select2-result"), g.addClass(p ? "select2-result-selectable" : "select2-result-unselectable"), f && g.addClass("select2-disabled"), m && g.addClass("select2-result-with-children"), g.addClass(l.opts.formatResultCssClass(h)), y = e("<div></div>"), y.addClass("select2-result-label"), v = n.formatResult(h, y, r), v !== t && y.html(v), g.append(y), m && (b = e("<ul></ul>"), b.addClass("select2-result-sub"), s(h.children, b, c + 1), g.append(b)), g.data("select2-data", h), o.append(g)
                            })(o, i, 0)
                        }
                    }, e.fn.select2.defaults, n), "function" != typeof n.id && (a = n.id, n.id = function (e) {
                        return e[a]
                    }), s ? (n.query = this.bind(function (n) {
                        var o, s, a, l = {results: [], more: !1}, c = n.term;
                        a = function (e, t) {
                            var o;
                        ...
                        }, o = r.children(), this.getPlaceholder() !== t && o.length > 0 && (s = o[0], "" === e(s).text() && (o = o.not(s))), o.each2(function (e, t) {
                            a(t, l.results)
                        }), n.callback(l)
                    }), n.id = function (e) {
                        return e.id
                ...
                var t, n, i, o = this.container.offset(), r = this.container.outerHeight(!1), s = this.container.outerWidth(!1), a = this.dropdown.outerHeight(!1), l = e(window).scrollLeft() + document.documentElement.clientWidth, c = e(window).scrollTop() + document.documentElement.clientHeight, u = o.top + r, d = o.left, h = c >= u + a, p = o.top - a >= this.body().scrollTop(), f = this.dropdown.outerWidth(!1), m = l >= d + f, g = this.dropdown.hasClass("select2-drop-above");
                "static" !== this.body().css("position") && (t = this.body().offset(), u -= t.top, d -= t.left), g ? (n = !0, !p && h && (n = !1)) : (n = !1, !h && p && (n = !0)), m || (d = o.left + s - f), n ? (u = o.top - a, this.container.addClass("select2-drop-above"), this.dropdown.addClass("select2-drop-above")) : (this.container.removeClass("select2-drop-above"), this.dropdown.removeClass("select2-drop-above")), i = e.extend({
                    top: u,
                    left: d,
                    width: s
                }, v(this.opts.dropdownCss)), this.dropdown.css(i)
            }, shouldOpen: function () {
                var t;
                ...
                var t = this.containerId, n = this.containerSelector, i = "scroll." + t, o = "resize." + t;
                this.container.parents().each(function () {
                    e(this).bind(i, function () {
                        var t = e(n);
                        0 == t.length && e(this).unbind(i), t.select2("close")
                    })
                }), window.setTimeout(function () {
                    e(window).bind(o, function () {
                        var t = e(n);
                        0 == t.length && e(window).unbind(o), t.select2("close")
                    })
                ...
                if (n = this.highlight(), !(0 > n)) {
                    ...
                    t = l.find(".select2-result-selectable"), i = e(t[n]), o = i.offset().top + i.outerHeight(!0), n === t.length - 1 && (a = l.find("li.select2-more-results"), a.length > 0 && (o = a.offset().top + a.outerHeight(!0))), r = l.offset().top + l.outerHeight(!0), o > r && l.scrollTop(l.scrollTop() + (o - r)), s = i.offset().top - l.offset().top, 0 > s && "none" != i.css("display") && l.scrollTop(l.scrollTop() + s)
                }
                ...
                var e, t = this.results, n = t.find("li.select2-more-results"), i = this.resultsPage + 1, o = this, r = this.search.val(), s = this.context;
                        ...
                        callback: this.bind(function (s) {
                            ...
                            if (this.opened()) {
                                ...
                                c.empty(), d.opts.populateResults.call(this, c, s.results, {
                                    ...
                                    d.loadMoreIfNeeded()
                                }, 10)), this.postprocessResults(s, n), o()
                            }
                        })
                    })
                }
                ...
                var t = this.highlight(), n = this.results.find(".select2-highlighted").not(".select2-disabled"), i = n.closest(".select2-result-selectable").data("select2-data");
            ...
            createContainer: function () {
                ...
                var e, t = this.container, n = this.dropdown, i = !1;
                ...
                return "select" === t.element.get(0).tagName.toLowerCase() && (t.initSelection = function (t, n) {
                    ...
                    e.isFunction(n) && n({id: i.attr("value"), text: i.text(), element: i})
                }), t
                ...
                }), this.highlight(o), n === !0 && (s = this.showSearchInput = _(t.results) >= this.opts.minimumResultsForSearch, this.dropdown.find(".select2-search")[s ? "removeClass" : "addClass"]("select2-search-hidden"), e(this.dropdown, this.container)[s ? "addClass" : "removeClass"]("select2-with-searchbox"))
            }, onSelect: function (e, t) {
                var n = this.opts.element.val();
                this.opts.element.val(this.id(e)), this.updateSelection(e), this.close(), t && t.noFocus || this.selection.focus(), i(n, this.id(e)) || this.triggerChange()
            }, updateSelection: function (e) {
                var n, i = this.selection.find("span");
                this.selection.data("select2-data", e), i.empty(), n = this.opts.formatSelection(e, i), n !== t && i.append(this.opts.escapeMarkup(n)), this.selection.removeClass("select2-default"), this.opts.allowClear && this.getPlaceholder() !== t && this.selection.find("abbr").show()
            }, val: function () {
                var e, n = null, i = this;
                ...
                if (e = arguments[0], this.select)this.select.val(e).find(":selected").each2(function (e, t) {
                    ...
                    this.opts.element.val(e), this.opts.initSelection(this.opts.element, function (e) {
                        i.opts.element.val(e ? i.id(e) : ""), i.updateSelection(e), i.setPlaceholder(), i.triggerChange()
                    })
                }
            }, clearSearch: function () {
                this.search.val("")
            ...
            createContainer: function () {
                ...
                return "select" === t.element.get(0).tagName.toLowerCase() && (t.initSelection = function (t, n) {
                    ...
                    t.find(":selected").each2(function (e, t) {
                        i.push({id: t.attr("value"), text: t.text(), element: t})
                    }), e.isFunction(n) && n(i)
                }), t
            }, initContainer: function () {
                ...
                this.searchContainer = this.container.find(".select2-search-field"), this.selection = t = this.container.find(n), this.search.bind("keydown", this.bind(function (e) {
                    if (this.enabled) {
                        if (e.which === C.BACKSPACE && "" === this.search.val()) {
                            ...
                            if (i.length > 0)return this.unselect(i.first()), this.search.width(10), void d(e);
                ...
                }), t = o, this.selection.find(".select2-search-choice").remove(), e(t).each(function () {
                ...
                var i, o = !n.locked, r = e("<li class='select2-search-choice'>    <div></div>    <a href='#' onclick='return false;' class='select2-search-choice-close' tabindex='-1'></a></li>"), s = e("<li class='select2-search-choice select2-locked'><div></div></li>"), a = o ? r : s, l = this.id(n), c = this.getVal();
                i = this.opts.formatSelection(n, a.find("div")), i != t && a.find("div").replaceWith("<div>" + this.opts.escapeMarkup(i) + "</div>"), o && a.find(".select2-search-choice-close").bind("mousedown", d).bind("click dblclick", this.bind(function (t) {
                ...
                t = e.data("select2-data"), i = n(this.id(t), o), i >= 0 && (o.splice(i, 1), this.setVal(o), this.select && this.postprocessResults()), e.remove(), this.triggerChange({removed: t})
            }, postprocessResults: function () {
                var e = this.getVal(), t = this.results.find(".select2-result-selectable"), i = this.results.find(".select2-result-with-children"), o = this;
                ...
                e = p(this.search) + 10, t = this.search.offset().left, n = this.selection.width(), i = this.selection.offset().left, o = n - (t - i) - s, e > o && (o = n - s), 40 > o && (o = n - s), 0 >= o && (o = e), this.search.width(o)
            }, getVal: function () {
                var e;
                ...
                if (this.setVal(n), this.select)this.select.find(":selected").each(function () {
                    i.push({id: e(this).attr("value"), text: e(this).text()})
                }), this.updateSelection(i), this.triggerChange(); else {
                    if (this.opts.initSelection === t)throw new Error("val() cannot be called if initSelection() is not defined");
                    this.opts.initSelection(this.opts.element, function (t) {
                        var n = e(t).map(o.id);
                        o.setVal(n), o.updateSelection(t), o.clearSearch(), o.triggerChange()
                    })
                }
                this.clearSearch()
            ...
            var i, o, r, s, a = Array.prototype.slice.call(arguments, 0), l = ["val", "destroy", "opened", "open", "close", "focus", "isFocused", "container", "onSortStart", "onSortEnd", "enable", "disable", "positionDropdown", "data"];
            return this.each(function () {
                if (0 === a.length || "object" == typeof a[0])i = 0 === a.length ? {} : e.extend({}, a[0]), i.element = e(this), "select" === i.element.get(0).tagName.toLowerCase() ? s = i.element.attr("multiple") : (s = i.multiple || !1, "tags"in i && (i.multiple = s = !0)), o = s ? new S : new T, o.init(i); else {
            ...
            formatResult: function (e, t, n) {
                var i = [];
                return f(e.text, n.term, i, this.escapeMarkup), i.join("")
            },
            ...
            query: {ajax: m, local: g, tags: y},
            util: {debounce: l, markMatch: f},
            "class": {"abstract": k, single: T, multi: S}
        }
    }
}(jQuery), function (e) {
    function t(e, t, o) {
        var r = e[0], s = /er/.test(o) ? _indeterminate : /bl/.test(o) ? f : h, a = o == _update ? {
            checked: r[h],
            disabled: r[f],
            indeterminate: "true" == e.attr(_indeterminate) || "false" == e.attr(_determinate)
        } : r[s];
        if (/^(ch|di|in)/.test(o) && !a)n(e, s); else if (/^(un|en|de)/.test(o) && a)i(e, s); else if (o == _update)for (var l in a)a[l] ? n(e, l, !0) : i(e, l, !0); else t && "toggle" != o || (t || e[_callback]("ifClicked"), a ? r[_type] !== d && i(e, s) : n(e, s))
    }

    function n(t, n, o) {
        var u = t[0], m = t.parent(), g = n == h, y = n == _indeterminate, b = n == f, v = y ? _determinate : g ? p : "enabled", _ = r(t, v + s(u[_type])), w = r(t, n + s(u[_type]));
        if (u[n] !== !0) {
            ...
            y ? (u[n] = !0, u[h] && i(t, h, "force")) : (o || (u[n] = !0), g && u[_indeterminate] && i(t, _indeterminate, !1)), a(t, g, n, o)
        }
        u[f] && r(t, _cursor, !0) && m.find("." + c).css(_cursor, "default"), m[_add](w || r(t, n) || ""), m.attr("role") && !y && m.attr("aria-" + (b ? f : h), "true"), m[_remove](_ || r(t, v) || "")
    }

    function i(e, t, n) {
        var i = e[0], o = e.parent(), l = t == h, u = t == _indeterminate, d = t == f, m = u ? _determinate : l ? p : "enabled", g = r(e, m + s(i[_type])), y = r(e, t + s(i[_type]));
        i[t] !== !1 && ((u || !n || "force" == n) && (i[t] = !1), a(e, l, m, n)), !i[f] && r(e, _cursor, !0) && o.find("." + c).css(_cursor, "pointer"), o[_remove](y || r(e, t) || ""), o.attr("role") && !u && o.attr("aria-" + (d ? f : h), "false"), o[_add](g || r(e, m) || "")
    }
    ...
    _determinate = "determinate", _indeterminate = "in" + _determinate, _update = "update", _type = "type", _click = "click", _touch = "touchbegin.i touchend.i", _add = "addClass", _remove = "removeClass", _callback = "trigger", _label = "label", _cursor = "cursor", _mobile = /ipad|iphone|ipod|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent), e.fn[l] = function (r, s) {
        ...
        if (/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(r))return r = r.toLowerCase(), m(this), p.each(function () {
            var n = e(this);
            "destroy" == r ? o(n, "ifDestroyed") : t(n, !0, r), e.isFunction(s) && s()
        });
        ...
        var g = e.extend({
            ...
            labelHover: !0
        }, r), y = g.handle, b = g.hoverClass || "hover", v = g.focusClass || "focus", _ = g.activeClass || "active", w = !!g.labelHover, x = g.labelHoverClass || "hover", C = 0 | ("" + g.increaseArea).replace("%", "");
        return (y == u || y == d) && (a = 'input[type="' + y + '"]'), -50 > C && (C = -50), m(this), p.each(function () {
            var r = e(this);
            o(r);
            var s, a = this, p = a.id, m = -C + "%", y = 100 + 2 * C + "%", k = {
                position: "absolute",
                top: m,
                left: m,
                display: "block",
                ...
                border: 0,
                opacity: 0
            }, T = _mobile ? {position: "absolute", visibility: "hidden"} : C ? k : {
                position: "absolute",
                opacity: 0
            }, S = a[_type] == u ? g.checkboxClass || "i" + u : g.radioClass || "i" + d, E = e(_label + '[for="' + p + '"]').add(r.closest(_label)), A = !!g.aria, N = l + "-" + Math.random().toString(36).substr(2, 6), F = '<div class="' + S + '" ' + (A ? 'role="' + a[_type] + '" ' : "");
            A && E.each(function () {
                F += 'aria-labelledby="', this.id ? F += this.id : (this.id = N, F += N), F += '"'
            }), F = r.wrap(F + "/>")[_callback]("ifCreated").parent().append(g.insert), s = e('<ins class="' + c + '"/>').css(k).appendTo(F), r.data(l, {
                o: g,
                s: r.attr("style")
            }).css(T), !!g.inheritClass && F[_add](a.className || ""), !!g.inheritID && p && F.attr("id", l + "-" + p), "static" == F.css("position") && F.css("position", "relative"), t(r, !0, _update), E.length && E.on(_click + ".i mouseover.i mouseout.i " + _touch, function (n) {
                ...
                var n = e[_type], i = /wn|up/.test(n) ? _ : b;
                if (!a[f]) {
        ...
        init: function (t) {
            ...
            if (t.append(this.options.template).find(".noty_text").html(this.options.text), this.$bar = null !== this.options.layout.parent.object ? e(this.options.layout.parent.object).css(this.options.layout.parent.css).append(t) : t, this.options.buttons) {
                ...
                e.each(this.options.buttons, function (t, n) {
                    var o = e("<button/>").addClass(n.addClass ? n.addClass : "gray").html(n.text).appendTo(i.$bar.find(".noty_buttons")).bind("click", function () {
    ...
    e.notyRenderer = {}, e.notyRenderer.init = function (n) {
        ...
        return i.options.force ? e.noty.queue.unshift(i) : e.noty.queue.push(i), e.notyRenderer.render(), "object" == e.noty.returns ? i : i.options.id
...
I18n.defaultLocale = "en", I18n.fallbacks = !1, I18n.defaultSeparator = ".", I18n.locale = null, I18n.PLACEHOLDER = /(?:\{\{|%\{)(.*?)(?:\}\}?)/gm, I18n.isValidNode = function (e, t, n) {
    ...
    var n, t = t || {}, i = e, o = this.prepareOptions(I18n.translations), r = o[t.locale || I18n.currentLocale()], t = this.prepareOptions(t);
    if (r) {
    ...
    for (var e, t = {}, n = arguments.length, i = 0; n > i; i++)if (e = arguments[i])for (var o in e)this.isValidNode(t, o) || (t[o] = e[o]);
    return t
}, I18n.interpolate = function (e, t) {
    t = this.prepareOptions(t);
    var n, i, o, r = e.match(this.PLACEHOLDER);
    if (!r)return e;
    for (var s = 0; n = r[s]; s++)o = n.replace(this.PLACEHOLDER, "$1"), i = t[o], this.isValidNode(t, o) || (i = "[missing " + n + " value]"), regex = new RegExp(n.replace(/\{/gm, "\\{").replace(/\}/gm, "\\}")), e = e.replace(regex, i);
    return e
    ...
    var i = e.getDay(), o = e.getDate(), r = e.getFullYear(), s = e.getMonth() + 1, a = e.getHours(), l = a, c = a > 11 ? 1 : 0, u = e.getSeconds(), d = e.getMinutes(), h = e.getTimezoneOffset(), p = Math.floor(Math.abs(h / 60)), f = Math.abs(h) - 60 * p, m = (h > 0 ? "-" : "+") + (p.toString().length < 2 ? "0" + p : p) + (f.toString().length < 2 ? "0" + f : f);
    l > 12 ? l -= 12 : 0 === l && (l = 12);
    var g = function (e) {
        var t = "0" + e.toString();
        return t.substr(t.length - 2)
    }, y = t;
    return y = y.replace("%a", n.abbr_day_names[i]), y = y.replace("%A", n.day_names[i]), y = y.replace("%b", n.abbr_month_names[s]), y = y.replace("%B", n.month_names[s]), y = y.replace("%d", g(o)), y = y.replace("%e", o), y = y.replace("%-d", o), y = y.replace("%H", g(a)), y = y.replace("%-H", a), y = y.replace("%I", g(l)), y = y.replace("%-I", l), y = y.replace("%m", g(s)), y = y.replace("%-m", s), y = y.replace("%M", g(d)), y = y.replace("%-M", d), y = y.replace("%p", n.meridian[c]), y = y.replace("%S", g(u)), y = y.replace("%-S", u), y = y.replace("%w", i), y = y.replace("%y", g(r)), y = y.replace("%-y", g(r).replace(/^0+/, "")), y = y.replace("%Y", r), y = y.replace("%z", m)
    ...
    var n, i, o = 0 > e, r = Math.abs(e).toFixed(t.precision).toString(), s = r.split("."), a = [];
    ...
    for (var n, i, o = 1024, r = e, s = 0; r >= o && 4 > s;)r /= o, s += 1;
    return 0 === s ? (n = this.t("number.human.storage_units.units.byte", {count: r}), i = 0) : (n = this.t("number.human.storage_units.units." + [null, "kb", "mb", "gb", "tb"][s]), i = r - Math.floor(r) === 0 ? 0 : 1), t = this.prepareOptions(t, {
        precision: i,
        format: "%n%u",
        delimiter: ""
    ...
    r = "undefined" != typeof exports && null !== exports ? exports : this, t = function (e) {
        this.message = e
    }, t.prototype = new Error, o = {prefix: "", default_url_options: {}}, e = {
        GROUP: 1,
        CAT: 2,
        SYMBOL: 3,
        OR: 4,
        ...
        serialize: function (e, t) {
            ...
            switch (c = [], this.get_object_type(e)) {
                case"array":
                    for (i = u = 0, d = e.length; d > u; i = ++u)n = e[i], c.push(this.serialize(n, t + "[]"));
                    break;
                case"object":
            ...
            var n, i, r, s, a;
            for (a = [], n = r = 0, s = e.length; s > r; n = ++r)i = e[n], !t.hasOwnProperty(i) && o.default_url_options.hasOwnProperty(i) && a.push(t[i] = o.default_url_options[i]);
            return a
            ...
            var i, o, r, s, a;
            for (o = this.clone(n) || {}, i = s = 0, a = e.length; a > s; i = ++s)r = e[i], i < t.length && (o[r] = t[i]);
            return o
            ...
            return a = this.prepare_parameters(e, o, s), this.set_default_url_options(t, a), r = this.extract_anchor(a), c = this.extract_trailing_slash(a), l = "" + this.get_prefix() + this.visit(i, a), u = n.clean_path("" + l), c === !0 && (u = u.replace(/(.*?)[\/]?$/, "$1/")), (d = this.serialize(a)).length && (u += "?" + d), u += r
            ...
            switch (null == o && (o = !1), c = n[0], r = n[1], a = n[2], c) {
                ...
                case e.DOT:
                    return r;
                case e.CAT:
                    return s = this.visit(r, i, o), l = this.visit(a, i, o), !o || s && l ? "" + s + l : "";
                case e.SYMBOL:
                    if (u = i[r], null != u)return delete i[r], this.path_identifier(u);
                    if (o)return "";
            ...
            var i, o, r, s;
            return r = e[0], i = e[1], o = e[2], i.replace(/^\*/i, "") !== i && (e[1] = i = i.replace(/^\*/i, "")), s = t[i], null == s ? this.visit(e, t, n) : (t[i] = function () {
            ...
            for (this._classToTypeCache = {}, i = "Boolean Number String Function Array Date RegExp Object Error".split(" "), t = 0, n = i.length; n > t; t++)e = i[t], this._classToTypeCache["[object " + e + "]"] = e.toLowerCase();
        ...
        return e = function (t, n) {
            var i, o;
            return o = n ? n.split(".") : [], o.length ? (i = o.shift(), t[i] = t[i] || {}, e(t[i], o.join("."))) : void 0
        }, e(r, "Routes"), r.Routes = {
            bookmarks_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "bookmarks", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, collection_note_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [7, "/", !1], [6, "collection_notes", !1]], [7, "/", !1]], [3, "id", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, collection_notes_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "collection_notes", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, destroy_user_session_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "sign_out", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, edit_editor_newsletter_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "editor", !1]], [7, "/", !1]], [6, "newsletters", !1]], [7, "/", !1]], [3, "id", !1]], [7, "/", !1]], [6, "edit", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, editable_collections_user_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "users", !1]], [7, "/", !1]], [3, "id", !1]], [7, "/", !1]], [6, "collections", !1]], [7, "/", !1]], [6, "editable", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, editor_newsletter_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "editor", !1]], [7, "/", !1]], [6, "newsletters", !1]], [7, "/", !1]], [3, "id", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, editor_newsletters_path: function () {
                return n.build_path([], ["format"], [2, [2, [2, [2, [7, "/", !1], [6, "editor", !1]], [7, "/", !1]], [6, "newsletters", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, fetch_collection_editor_collection_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "editor", !1]], [7, "/", !1]], [6, "collections", !1]], [7, "/", !1]], [3, "id", !1]], [7, "/", !1]], [6, "fetch_collection", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, fetch_notebook_editor_notebook_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "editor", !1]], [7, "/", !1]], [6, "notebooks", !1]], [7, "/", !1]], [3, "id", !1]], [7, "/", !1]], [6, "fetch_notebook", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, fetch_public_note_editor_note_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "editor", !1]], [7, "/", !1]], [6, "notes", !1]], [7, "/", !1]], [3, "id", !1]], [7, "/", !1]], [6, "fetch_public_note", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, fetch_user_editor_user_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "editor", !1]], [7, "/", !1]], [6, "users", !1]], [7, "/", !1]], [3, "id", !1]], [7, "/", !1]], [6, "fetch_user", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, following_collections_path: function () {
                return n.build_path([], ["format"], [2, [2, [2, [2, [7, "/", !1], [6, "collections", !1]], [7, "/", !1]], [6, "following", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, list_notebook_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "notebooks", !1]], [7, "/", !1]], [3, "id", !1]], [7, "/", !1]], [6, "latest", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, load_reading_url_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "load_reading_url", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, message_inbox_path: function () {
                return n.build_path([], ["format"], [2, [2, [2, [2, [7, "/", !1], [6, "messages", !1]], [7, "/", !1]], [6, "inbox", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, new_editor_newsletter_path: function () {
                return n.build_path([], ["format"], [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "editor", !1]], [7, "/", !1]], [6, "newsletters", !1]], [7, "/", !1]], [6, "new", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, note_further_reading_path: function () {
                return n.build_path(["note_id", "id"], ["format"], [2, [2, [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "notes", !1]], [7, "/", !1]], [3, "note_id", !1]], [7, "/", !1]], [6, "further_readings", !1]], [7, "/", !1]], [3, "id", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, note_further_readings_path: function () {
                return n.build_path(["note_id"], ["format"], [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "notes", !1]], [7, "/", !1]], [3, "note_id", !1]], [7, "/", !1]], [6, "further_readings", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, notifications_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "notifications", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, preferences_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "preferences", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, root_path: function () {
                return n.build_path([], [], [7, "/", !1], arguments)
            }, settings_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "settings", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, show_collection_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [7, "/", !1], [6, "collection", !1]], [7, "/", !1]], [3, "id", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, show_note_path: function () {
                return n.build_path(["slug"], ["format"], [2, [2, [2, [2, [7, "/", !1], [6, "p", !1]], [7, "/", !1]], [3, "slug", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, toggle_default_tab_path: function () {
                return n.build_path([], ["format"], [2, [2, [2, [2, [7, "/", !1], [6, "preferences", !1]], [7, "/", !1]], [6, "toggle_default_tab", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, top_daily_path: function () {
                return n.build_path([], ["format"], [2, [2, [2, [2, [7, "/", !1], [6, "top", !1]], [7, "/", !1]], [6, "daily", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, undismiss_comment_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [2, [2, [7, "/", !1], [6, "comments", !1]], [7, "/", !1]], [3, "id", !1]], [7, "/", !1]], [6, "undismiss", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, update_further_reading_state_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "update_further_reading_state", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, user_path: function () {
                return n.build_path(["id"], ["format"], [2, [2, [2, [2, [7, "/", !1], [6, "users", !1]], [7, "/", !1]], [3, "id", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, user_timeline_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "timeline", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }, writer_path: function () {
                return n.build_path([], ["format"], [2, [2, [7, "/", !1], [6, "writer", !1]], [1, [2, [8, ".", !1], [3, "format", !1]], !1]], arguments)
            }
        }, r.Routes.options = o, r.Routes
...
I18n.translations = I18n.translations || {}, I18n.translations.en = {
    kalamu: {
        link_format_error: "Only http, https and ftp are supported.",
        insert_image: "Insert Image",
        local_image: "from computer",
        or: "or",
        internet_image: "from internet",
        ...
        image_url_blank: "Please enter image url",
        insert_link: "Insert Link",
        link_url: "Link url",
        link_text: "Link text",
        wrong_image_file_format: "Invalid image file format, please use jpg/jpeg/png/gif file.",
        size_excceed_limit: "File too large, please choose file under 5MB.",
        image_url_blank: "Please enter image url.",
        image_protocol_not_supported: "Url protocol not supported.",
        select_image: "Select image to upload",
        image_privacy: " Click question mark to learn more about privacy on upload images",
        upload_internal_server_error: "Upload failed, please try again."
    },
    ie_warning: {
        title: "Your Internet Explorer version is too low",
        upgrade_ie: 'Please <a href="http://windows.microsoft.com/en-us/internet-explorer/downloads/ie-9/worldwide-languages">upgrade your Internet Explorer</a>.',
        use_chrome: 'Or use <a href="http://www.google.com/chrome" class="use-chrome"> Google Chrome </a> to have the best experience on jianshu.com',
        skip: "Skip"
    },
    reading: {
        registration_complete: "Registration is successful, now redirecting...",
        errors: {email_invalid: "Email address is invalid."},
        download_changweibo_image: "Download ChangWeibo Image",
        following: " Following",
        unfollow: " Unfollow",
        subscribing: " Subscribing",
        unsubscribe: " Unsubscribe",
        subscribing_with_likes: " Subscribing | {{total_likes}}",
        unsubscribe_with_likes: " Unsubscribe | {{total_likes}}",
        bian: "",
        remove: "Remove",
        comment: {
            undismiss_button: "Undo",
            dismiss_info: "Comment was dismissed",
            undismiss_info: "Comment was made public"
        },
        reject: {
            title: "Decline this article",
            description: "You could write something back to the author, otherwise we won't email the author about it.",
            placeholder: "Add an optional note for the author",
            close: "Cancel",
            submit: "OK"
        },
        further_reading: {
            ...
            from: " on ",
            add: "add",
            states: {"private": " Private", "public": " Public", dismiss: " Delete"},
            load_link_error: "An error occurred, and we were unable to load this link.",
            undo_link: "The link is now{{state}}\u30fb<a class='undo' data-further-reading-id='{{id}}' data-state='{{originState}}' href='javascript:void(null)'>\u64a4\u9500</a>",
            link_text_placeholder: "Paste a link to content related to this post",
            title_placeholder: "Edit title",
            description_placeholder: "Edit description",
            delete_success: "Deleted successfully"
        },
        timeline: {show_comments: "Show comments", collapse_comments: "Collapse", reply: "Reply", "delete": "Delete"},
        self_destruction_confirm: "Please confirm you really want to destroy your account, there's no way back!",
        delete_comment_confirm: "Confirm to delete your comment?",
        collections: {select_note: "Select a note:", select_note_error: "Please select a note."},
        social_sharing: {
            trailing_jianshushe: "- jianshu.com",
            share_to_label: {
                weibo: "Share it on Weibo",
                tweibo: "Share it on Tencent Weibo",
                qzone: "Share it on QQ zone",
                douban: "Share it on Douban",
                twitter: "Share it on Twitter",
                facebook: "Share it on Facebook",
                google_plus: "Share it on Google+",
                renren: "Share it on RenRen"
            },
            self_share_note_text: 'I just wrote a new article "{{note_title}}". Check it out! ',
            reader_share_note_text: 'I recommend "{{note_title}" by {{user}}. ',
            official_account: "via {{account}}"
        }
    },
    note_logs: {
        list_title: "Total {{count}} versions",
        apply_this_log: "Switch to this version",
        filter: "Filter",
        types: {
            autosave: "Autosave",
            publish: "Publish article",
            post_updates: "Publish changes",
    ...
    delete_notebook_confirm: 'Please confirm to delete this notebook: "{{title}}". The notes in this notebook will also be deleted and the action is not reversible.',
    delete_note_confirm: 'Please confirm to delete this note: "{{title}}". The action is not reversible.',
    rename_notebook: "Rename Notebook",
    delete_notebook: "Delete Notebook",
    saving: "Saving...",
    saved: "Saved",
    compiled: "Changes published successfully.",
    saved_partially: "Some content at the tail is not saved",
    change_notebook_placeholder: "Select a notebook to move into...",
    wordage: "Wordage: {{wordage}}",
    commerical_placeholder: "A notebook for writers. A pure enviroment to concentrate on writing.",
    notebook_name_placeholder: "Please input a notebook name...",
    nickname_format_invalid: "Nickname is valid.",
    nickname: "Nickname",
    spine_ajax_pending: "Data is still being sent to the server; you may lose unsaved changes if you close the page.",
    form_dirty: "Unsaved content detected. Are you sure you want to leave this page?",
    toggle_to_markdown: "Toggle preferred type to Markdown",
    toggle_to_plain: "Toggle preferred type to Plain Text",
    suggest_chrome: "We find you are using Internet Explorer, we suggest using Google Chrome for the best experience on jianshu.com",
    suggest_upgrade: "We find you are using Internet Explorer 8/9, using these old browsers, you will encounter performance issues, and also we couldn't provider our functions completely. We suggest using Google Chrome for the best experience, or you could upgrade to Internet Explorer 10 for complete functions.",
    chrome_bug: "We've found existing bug for this Chrome version (33.0.1750.152), you will not be able to upload images/edit link from RichText editor. Please upgrade to the latest Chrome version.",
    restore_a_locale_copy: "We restored a locale copy of this note. If it's not your latest version you could: ",
    leaving_note_unsaved: "Your note has modified data and it's not saved, save it?",
    press_esc_to_leave: "Press ESC to leave.",
    new_note_bottom: "New Note Below",
    ajax_error: "Error detected, please backup your current unsaved work and refresh page.",
    publish: "Publish",
    published: "Published",
    unpublish: "Unpublish",
    ...
    toolbar: {
        writing_mode: "Switch to Writing Mode",
        preview_mode: "Switch to Preview Mode",
        save: "Save",
        redo: "Redo",
        undo: "Undo",
        bold: "Bold",
    ...
    errors: {
        401: "Authentication failed, please manually save your current work and refresh this page",
        404: "Note/Notebook not found, please refresh this page",
        500: "Server error, please manually save your current work and refresh this page",
        writer_version_conflict: "You have already updated this article somewhere else. In order not to lose any content, please manually backup your article and refresh this page.",
        content_overflow: "Size of current article is already above the limit, some content at the tail is not saved. Please manual backup your content first and then create a new article."
    },
    warnings: {content_too_large: "Size of current article is reaching the limit. Please consider opening up a new one."},
    network: {
        issue: "You network connection is experiencing problem, may come back...backup your current working for good...",
        down: "You network connection may be down, make sure you backup what you are writing!",
        back: "You network connection is back."
    },
    navbar: {
        homepage: "Homepage",
    ...
    note_modified: {
        mac: "Note modified, press command + s to save it.",
        nonmac: "Note modified, press ctrl + s to save it."
    },
    note: {
        untitled: "Untitled",
        dropdown: {
            share_directly: "Share it !",
            move_note: "Move note",
        ...
        moving: {title: "Move Note To"},
        share: {
            title: "Publish it",
            help: "After click the publish button, every one could access your note via the following link.",
            permanent_link: "Permanent Link",
            success: "Successfully published. Permanent Link:",
            to_sns: "You could share it to your friends: "
        },
        shareToWeibo: {
            share: "Share",
            done: "Done, share with ChangeWeibo image",
            download: "Download ChangeWeibo image",
            processing: "Fetching ChangWeibo image",
            processingNotice: "We are generating an image for your article, normally it takes around 10s. If you do not need an image for you weibo, you can just click the share buton below."
        }
    },
    share: {
        text: 'Check out my new writing "{{note_title}}"!',
        official_account: "via @{{official_account}}.",
        trailing_jianshushe: "- jianshu.com"
    },
    button: {
        ...
        ok: "OK",
        undo: "Undo",
        upload_image_notice: "Direct drag and drop your image file to the editing area will perform the upload."
    },
    "jquery-timeago": {
        prefixAgo: null,
        prefixFromNow: null,
    ...
    datetime: {
        ...
        }, prompts: {year: "Year", month: "Month", day: "Day", hour: "Hour", minute: "Minute", second: "Seconds"}
    }
};
var I18n = I18n || {};
I18n.translations = I18n.translations || {}, I18n.translations["zh-CN"] = {
    ...
    reading: {
        ...
        subscribing: " \u6b63\u5728\u8ba2\u9605",
        unsubscribe: " \u53d6\u6d88\u8ba2\u9605",
        subscribing_with_likes: " \u6b63\u5728\u8ba2\u9605 | {{total_likes}}",
        unsubscribe_with_likes: " \u53d6\u6d88\u8ba2\u9605 | {{total_likes}}",
        bian: " \u7f16",
        remove: "\u79fb\u9664",
        comment: {
            undismiss_button: "\u64a4\u9500",
    ...
    note: {
        ...
        shareToWeibo: {
            ...
            processingNotice: "\u6211\u4eec\u6b63\u5728\u4e3a\u60a8\u751f\u6210\u957f\u5fae\u535a\u56fe\u7247, \u4e00\u822c\u89c6\u6587\u7ae0\u7bc7\u5e45\u4f1a\u9700\u8981 5-30 \u79d2\u7684\u65f6\u95f4\uff0c\u5982\u679c\u60a8\u4e0d\u9700\u8981\u5e26\u957f\u5fae\u535a\u5206\u4eab\uff0c\u53ef\u70b9\u51fb\u4e0b\u9762\u7684\u5206\u4eab\u6309\u94ae\u76f4\u63a5\u5206\u4eab\uff0c\u65e0\u9700\u7b49\u5f85\u3002"
        }
    },
    share: {
...
I18n.translations = I18n.translations || {}, I18n.translations["zh-TW"] = {
    kalamu: {
        ...
        upload_internal_server_error: "\u4e0a\u50b3\u5931\u6557, \u8acb\u91cd\u8a66\u3002"
    },
    ie_warning: {
        title: "\u60a8\u7684\u700f\u89bd\u5668\u7248\u672c\u904e\u4f4e",
    ...
    reading: {
        ...
        errors: {email_invalid: "\u90f5\u4ef6\u5730\u5740\u683c\u5f0f\u6709\u8aa4"},
        download_changweibo_image: "\u4e0b\u8f09\u9577\u5fae\u535a\u5716\u7247",
        following: " \u6b63\u5728\u95dc\u6ce8",
        unfollow: " \u53d6\u6d88\u95dc\u6ce8",
        subscribing: " \u6b63\u5728\u8a02\u95b1",
        unsubscribe: " \u53d6\u6d88\u8a02\u95b1",
        subscribing_with_likes: " \u6b63\u5728\u8a02\u95b1 | {{total_likes}}",
        unsubscribe_with_likes: " \u53d6\u6d88\u8a02\u95b1 | {{total_likes}}",
        bian: " \u7de8",
        remove: "\u79fb\u9664",
        comment: {
            undismiss_button: "\u64a4\u92b7",
        ...
        self_destruction_confirm: "\u8acb\u78ba\u8a8d\u60a8\u78ba\u5be6\u8981\u522a\u9664\u60a8\u7684\u8cec\u6236, \u6b64\u64cd\u4f5c\u7121\u6cd5\u6062\u5fa9!",
    ...
    chrome_bug: "\u6211\u5011\u767c\u73fe\u60a8\u7576\u524d\u7684\u700f\u89bd\u5668\u7248\u672c\uff0833.0.1750.152\uff09\u5b58\u5728\u5df2\u77e5\u7684bug\uff0c\u5728\u7576\u524d\u7684 Chrome \u7248\u672c\u4e0b\u60a8\u5c07\u7121\u6cd5\u5728\u5bcc\u6587\u672c\u7de8\u8f2f\u5668\u4e2d\u4e0a\u50b3\u5716\u7247/\u7de8\u8f2f\u93c8\u63a5\uff0c\u8acb\u5347\u7d1a\u81f3\u6700\u65b0\u7684Chrome\u7248\u672c\u3002",
    ...
    note: {
        ...
        shareToWeibo: {
            ...
            download: "\u4e0b\u8f09\u9577\u5fae\u535a\u5716\u7247",
            processing: "\u7372\u53d6\u9577\u5fae\u535a\u5716\u7247\u4e2d",
            processingNotice: "\u6211\u5011\u6b63\u5728\u7232\u60a8\u751f\u6210\u9577\u5fae\u535a\u5716\u7247, \u4e00\u822c\u8996\u6587\u7ae0\u7bc7\u5e45\u6703\u9700\u898110-30\u79d2\u7684\u6642\u9593\uff0c\u5982\u679c\u60a8\u4e0d\u9700\u8981\u5e36\u9577\u5fae\u535a\u5206\u4eab\uff0c\u53ef\u9ede\u64ca\u4e0b\u9762\u7684\u5206\u4eab\u6309\u9215\u76f4\u63a5\u5206\u4eab\uff0c\u7121\u9700\u7b49\u5f85\u3002"
        }
    },
    share: {
    ...
    button: {
        ...
        ok: "\u78ba\u8a8d",
        undo: "\u64a4\u92b7",
        upload_image_notice: "\u5c07\u5716\u7247\u6587\u4ef6\u76f4\u63a5\u62d6\u52d5\u5230\u7de8\u8f2f\u5340\u57df\u5373\u53ef\u4e0a\u50b3"
    },
    "jquery-timeago": {
        prefixAgo: null,
        prefixFromNow: "\u5f9e\u73fe\u5728\u958b\u59cb",
    ...
    Maleskine.Settings = {
        ...
        asset_host: "http://jianshu-prd.b0.upaiyun.com",
    ...
    Maleskine.Utils = {
        regexps: {acceptableImage: /(\.|\/)(jpe?g|png|gif)$/i}, setCookie: function (e, t) {
            var n, i;
            return n = new Date, i = n.getTime(), i += 31536e9, n.setTime(i), document.cookie = "" + e + "=" + t + "; expires=" + n.toGMTString() + "; path=/"
        }, image_tag: function () {
            return function (e, t) {
                var n;
                return null == t && (t = {}), n = '<img src="' + Maleskine.Settings.asset_host + "/assets/" + e + '" ', null != t["class"] && (n += 'class="' + t["class"] + '"'), n += " />"
            }
        }(this), toTitleCase: function (e) {
            ...
            var t, n, i;
            for (null == e && (e = 5), i = "", n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", t = 0; e > t;)i += n.charAt(Math.floor(Math.random() * n.length)), t++;
            return i
        }, isAcceptableImageType: function (e) {
            return Maleskine.Utils.regexps.acceptableImage.test(e)
        }, setDay: function () {
            return function () {
            ...
            var t, n, i, o, r, s;
            for (r = $(e).find("button.ladda-button[data-remote]"), s = [], i = 0, o = r.length; o > i; i++)n = r[i], t = Ladda.create(n), $(n).on("ajax:beforeSend", function () {
                return function () {
                    return t.start()
                }
            }(this)), s.push($(n).on("ajax:complete", function () {
                return function () {
                    return t.stop()
                }
            }(this)));
            ...
            var t, n, i;
            return t = $(e), i = Maleskine.Utils.fromClassNameToClassName(t.data("js-module")), i.length > 0 ? n = "function" == typeof Maleskine[i] ? new Maleskine[i]({el: t}) : void 0 : void 0
